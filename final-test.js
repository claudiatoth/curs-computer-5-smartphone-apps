// ============================================
// TEST FINAL - Computer & Büro Teil 5: Smartphone & Apps (A2/B1)
// Claudia Toth · 15 întrebări mixte
// ============================================

const finalTestData = [
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „der Akku"?', options: ['bateria', 'ecranul', 'camera'], correct: 'bateria', explanation: 'der Akku = bateria / acumulatorul.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „das Update"?', options: ['actualizarea', 'încărcătorul', 'setarea'], correct: 'actualizarea', explanation: 'das Update = actualizarea.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „die Einstellungen"?', options: ['setările', 'notificările', 'pozele'], correct: 'setările', explanation: 'die Einstellungen = setările.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „die Benachrichtigung"?', options: ['notificarea', 'cartela SIM', 'tonul de apel'], correct: 'notificarea', explanation: 'die Benachrichtigung = notificarea.' },
    { type: 'multiple', category: '⚙️ Acțiuni', question: 'Was tut man, wenn der Akku leer ist?', options: ['den Akku aufladen', 'die Kamera öffnen', 'den Klingelton ändern'], correct: 'den Akku aufladen', explanation: 'den Akku aufladen = a încărca bateria.' },
    { type: 'multiple', category: '⚙️ Acțiuni', question: 'Wo schaltet man Benachrichtigungen aus?', options: ['in den Einstellungen', 'im App Store', 'in der Kamera'], correct: 'in den Einstellungen', explanation: 'Notificările se reglează în die Einstellungen.' },
    { type: 'multiple', category: '🎯 Situație', question: 'Der Speicher ist voll. Was tun?', options: ['alte Apps oder Fotos löschen', 'den Akku wechseln', 'lauter stellen'], correct: 'alte Apps oder Fotos löschen', explanation: 'Eliberezi memoria ștergând aplicații/poze vechi.' },
    { type: 'multiple', category: '🎯 Situație', question: 'Die Kamera funktioniert nicht. Was hilft oft?', options: ['das Handy neu starten', 'die SIM-Karte wegwerfen', 'das Ladegerät kaufen'], correct: 'das Handy neu starten', explanation: 'O repornire rezolvă des problema.' },
    { type: 'multiple', category: '📝 Gramatică', question: 'Care e Partizip II corect pentru „aktualisieren"?', options: ['aktualisiert', 'geaktualisiert', 'aktualisiergt'], correct: 'aktualisiert', explanation: 'Verbele în -ieren NU primesc „ge-": aktualisiert.' },
    { type: 'multiple', category: '📝 Gramatică', question: 'Verbul „aufladen" la „er" (Präsens):', options: ['er lädt auf', 'er ladet auf', 'er aufladet'], correct: 'er lädt auf', explanation: 'laden e tare cu a→ä: er lädt; separabil → er lädt auf.' },
    { type: 'luckentext', category: '✍️ Verb (Perfekt)', question: 'Completează (separabil auf-, TARE):', sentence: 'Ich habe den Akku ______. (aufladen)', translation: 'Am încărcat bateria.', accept: ['aufgeladen'], correct: 'aufgeladen', explanation: 'aufladen → auf-ge-laden.' },
    { type: 'luckentext', category: '✍️ Verb (be-)', question: 'Completează (NESEPARABIL be-):', sentence: 'Ich habe die App oft ______. (benutzen)', translation: 'Am folosit des aplicația.', accept: ['benutzt'], correct: 'benutzt', explanation: 'benutzen → benutzt (be- nu primește ge-).' },
    { type: 'luckentext', category: '✍️ Vocabular activ', question: 'Completează (a actualiza — Präsens, ich):', sentence: 'Ich ______ die App jeden Monat. (aktualisieren)', translation: 'Actualizez aplicația în fiecare lună.', accept: ['aktualisiere'], correct: 'aktualisiere', explanation: 'aktualisieren → ich aktualisiere.' },
    { type: 'luckentext', category: '✍️ Traducere', question: 'Tradu în germană:', sentence: '„Bateria mea e aproape goală."', translation: 'Mein Akku ist fast leer.', accept: ['mein akku ist fast leer'], correct: 'Mein Akku ist fast leer.', explanation: 'der Akku = bateria; leer = gol(ă).' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was rät Frau Richter gegen den schnell leeren Akku?', options: ['Apps schließen und Helligkeit reduzieren', 'die SIM-Karte tauschen', 'eine neue Kamera kaufen'], correct: 'Apps schließen und Helligkeit reduzieren', explanation: 'Frau Richter: „Schließen Sie Apps im Hintergrund und reduzieren Sie die Helligkeit."' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong>: vocabularul de telefon și aplicații, acțiunile de bază, verbele și înțelegerea dialogului.</p>
