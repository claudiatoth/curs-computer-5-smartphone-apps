// ============================================
// PDF BUILDER — Computer & Büro Teil 5: Smartphone & Apps (A2/B1)
...
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Smartphone & Apps (Grundwortschatz)</h1>` + t;
    }
    ...
    function buildDialog() {
        ...
        dialog1Data.replici.forEach(r => {
            const sp = r.speaker === 'andreea' ? 'Andreea 🇷🇴' : 'Frau Richter 📱';
    ...
    function buildFlashcards() {
        let html = `<h1 class="chapter new-section">📇 4. Vocabular complet (Flashcards)</h1>
            <p style="margin-bottom:14px">Cele <strong>${typeof flashcardsData !== 'undefined' ? flashcardsData.length : 0} de carduri</strong> ale lecției — vocabularul pentru smartphone și aplicații.</p>
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 5. Verb-Konjugation — verbe pentru telefon</h1>
            <div class="theory-box warn-box"><p><strong>📌 Reamintire:</strong> aktualisieren e în -ieren (fără ge-: aktualisiert). aufladen e TARE SEPARABIL (a→ä: lädt auf). einschalten e regulat SEPARABIL (eingeschaltet). drücken e regulat (gedrückt; ≠ drucken!). benutzen e regulat NESEPARABIL (be-, fără ge-: benutzt). Präteritum = IMPERFECT.</p></div>`;
